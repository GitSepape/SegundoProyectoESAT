<main>
    ...
    <section class="producto">
        <article class="producto__comprar">
            <div class="grid_cell--35 producto__comprar--imagen">
                <img src="../../images/papaya-naranja.jpg" alt="" class="imagen__fruta">
            </div>
            <div class="grid_cell--55 producto__comprar--texto">
                <p class="producto__texto color-orange producto__texto--nombre">Papaya y naranja</p>
                ...
                <p class="producto__texto producto__texto--descripcion">
                    Este producto contiene 250 gramos de papaya y 250 gramos de naranja dando como resultado 2 smoothies medianos o 1 completo. 
                </p>
                <p class="producto__texto producto__texto--descripcion">

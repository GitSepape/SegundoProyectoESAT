    ...
    <section class="producto">
        <article class="producto__comprar">
            <div class="grid_cell--35 producto__comprar--imagen">
                <img src="../../images/fresa-mango.jpg" alt="" class="imagen__fruta">
            </div>
            <div class="grid_cell--55 producto__comprar--texto">
                <p class="producto__texto color-orange producto__texto--nombre">Fresa y mango</p>
                ...
                <p class="producto__texto producto__texto--descripcion">
                    Este producto contiene 250 gramos de fresa y 250 gramos de mango dando como resultado 2 smoothies medianos o 1 completo. 
                </p>
                <p class="producto__texto producto__texto--descripcion">
